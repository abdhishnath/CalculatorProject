...
for (text, row, col) in buttons:
    ...
    if text == "=":
        ...
        # Operator aur numbers ke liye
        display_to_code = {"x": "*", "/": "/", "-": "-", "+": "+"}
        val = display_to_code.get(text, text)
        action = lambda v=val: click_button(v)

    # Button ko grid mein place karna
    if text == "History":
